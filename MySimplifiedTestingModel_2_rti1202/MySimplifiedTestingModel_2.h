...
typedef struct {
  ...
  uint32_T Cast;                       /* '<S11>/Cast' */
  uint32_T Reshape;                    /* '<S11>/Reshape' */
  int32_T SFunction1_o3;               /* '<S5>/S-Function1' */
  int32_T SFunction1;                  /* '<S13>/S-Function1' */
  ...
  uint8_T u[64];                       /* '<S1>/MATLAB Function4' */
  uint8_T y[2];                        /* '<S1>/MATLAB Function' */
  uint8_T command[127];                /* '<S1>/Create 8-Bytes Command' */
  uint8_T TmpSignalConversionAtSFunctionI[127];/* '<S1>/BUS MASTER FSM' */
 ...
 * '<S10>'  : 'MySimplifiedTestingModel_2/RS485/MATLAB Function4'
 * '<S11>'  : 'MySimplifiedTestingModel_2/RS485/Subsystem'
 * '<S12>'  : 'MySimplifiedTestingModel_2/RS485/ZKDM FSM'
 * '<S13>'  : 'MySimplifiedTestingModel_2/RS485/Subsystem/DS1202SER_TX_C1'
 * '<S14>'  : 'MySimplifiedTestingModel_2/RTI Data/RTI Data Store'
 * '<S15>'  : 'MySimplifiedTestingModel_2/RTI Data/RTI Data Store/RTI Data Store'
 * '<S16>'  : 'MySimplifiedTestingModel_2/RTI Data/RTI Data Store/RTI Data Store/RTI Data Store'
 */
