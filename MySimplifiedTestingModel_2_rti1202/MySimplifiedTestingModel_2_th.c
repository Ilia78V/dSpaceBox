/************************ dSPACE target specific file *************************
   ...
   Include file .\MySimplifiedTestingModel_2_rti1202\MySimplifiedTestingModel_2_th.c :
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\MySimplifiedTestingModel_2_rti1202\MySimplifiedTestingModel_2_th.c is for ST).
# endif
