...
#
#  $RCSfile: rti1202.tmf $ $Revision: 1.45 $ $Date: 2020/08/18 11:52:54CEST $
...
MAKEFILE                       = MySimplifiedTestingModel_20x2810x29.mk
BUILDARGS                      =  EXTMODE_STATIC_ALLOC=0 TMW_EXTMODE_TESTING=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 MAT_FILE=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 OPTS="-DTID01EQ=1"
MATLAB_ROOT                    = C:\Program Files\MATLAB\R2023a
MATLAB_BIN                     = C:\Program Files\MATLAB\R2023a\bin
MATLAB_ROOT_ALT                = C:\PROGRA~1\MATLAB\R2023a
MATLAB_BIN_ALT                 = C:\PROGRA~1\MATLAB\R2023a\bin
RELEASE_VERSION                = R2023a
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN64
MODEL                          = MySimplifiedTestingModel_20x2810x29
MODULES                        = MySimplifiedTestingModel_20x2810x29_data.c MySimplifiedTestingModel_20x2810x29_trc_ptr.c
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = $(START_DIR)\slprj\rti1202\_sharedutils\rtwshared.lib
SOLVER                         = 
NUMST                          = 2
TID01EQ                        = 1
NCSTATES                       = 0
...
MASTER_ANCHOR_DIR              = 
START_DIR                      = M:\HiWi dSpace\Emulsionsanlage_Raja_Jan_25\0_ilia\r2023a
# Shared library for utility code
RTW_SHARED_LIB_SRCS_WILD       = ..\slprj\rti1202\_sharedutils\*.c*
RTW_SHARED_LIB_SRCS_DIR        = ..\slprj\rti1202\_sharedutils
RTW_SHARED_LIB_OBJS_DIR        = ..\slprj\rti1202\_sharedutils
RTW_SHARED_LIB                 = ..\slprj\rti1202\_sharedutils\rtwshared.lib
RTW_MODELLIB                   = 
...
RTWCUST_INCLUDES = \
    "$(START_DIR)" \
    "$(START_DIR)\MySimplifiedTestingModel_20x2810x29_rti1202" \
    "$(MATLAB_ROOT)\extern\include" \
    "$(MATLAB_ROOT)\simulink\include" \
    "$(MATLAB_ROOT)\rtw\c\src" \
    "$(MATLAB_ROOT)\rtw\c\src\ext_mode\common" \
    "$(START_DIR)\slprj\rti1202\_sharedutils"
