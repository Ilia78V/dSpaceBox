/************************ dSPACE target specific file *************************
   ...
   Include file .\MySimplifiedTestingModel_20x2810x29_rti1202\MySimplifiedTestingModel_20x2810x29_th.c :

   Task Configuration file for model : MySimplifiedTestingModel_20x2810x29

   RTI1202 23.1 (02-May-2023)/2.20
   08-Dec-2025 11:32:07
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\MySimplifiedTestingModel_20x2810x29_rti1202\MySimplifiedTestingModel_20x2810x29_th.c is for ST).
# endif
